...
<head>
    ...
    <script src="https://kit.fontawesome.com/a7c27b4e76.js" crossorigin="anonymous"></script>
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                     ...
                     <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                         ...
                         <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-cart-shopping" style="color: #828282;"></i><span class="hide-menu">Store</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_menu.php">All Item</a></li>
